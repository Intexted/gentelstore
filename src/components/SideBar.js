...
function SideBar() {
  const { PageControle, setPageControle } = useContext(MyContext);

  return (
    <div
      className={`sidebar  has-scrollbar ${
        PageControle?.showCategory ? 'active' : ''
      }`}
    >
      <div className='sidebar-category'>
        <div className='sidebar-top'>
          ...
          <button
            ...
            onClick={() => {
              setPageControle((page) => ({ ...page, showCategory: false }));
            }}
          >
      ...
      <div className='product-showcase'>
        <h3 className='showcase-heading'>{t('best products')}</h3>
